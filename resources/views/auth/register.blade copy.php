                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_1" type="text" class="form-control @error('phone_1') is-invalid @enderror" name="phone_1" value="{{ old('phone_1') }}" required autocomplete="phone_1" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_2" type="text" class="form-control @error('phone_2') is-invalid @enderror" name="phone_2" value="{{ old('phone_2') }}" required autocomplete="phone_2" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="rol" id="selectRol">
                                <option value="3">Validadores</option>
