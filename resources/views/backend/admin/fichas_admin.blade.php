        ...
        <div class="card card-custom">
            <div class="card-body">
                    ...
                    <div class="row align-items-center ">
                        <div class="col-md-12">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3 col-sm-6 col-6">
                                    <a class="btn btn-light-primary px-6 font-weight-bold" href="{{route('export.fichas')}}">Export CSV</a>
                                </div>
                            </div>
                        </div>
                        <!--begin::Button-->
                ...
                <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatable" @if(DevideDetect::isIOS()) style="overflow: auto" @endif>
                    ...
                    <table class="datatable  datatable-bordered datatable-head-custom extra" id="kt_datatable">
                        <thead class="datatable-head">

                            <tr class="datatable-row">
                                <th data-field="id" class="datatable-cell datatable-cell-sort"><span>@lang('Id propiedad')</span></th>
                                <th data-field="id_re" class="datatable-cell datatable-cell-sort"><span>@lang('Id inmobiliaria')</span></th>
                                <th data-field="open_date" class="datatable-cell datatable-cell-sort"><span style="width: 115px;">Fecha de apertura de ficha</span></th>
                        ...
                        <tbody class="datatable-body" style="">
                            ...
                            <tr class="datatable-row" style="left: 0px;">
                                ...
                                <td data-field="id" class="datatable-cell"><span>{{$property->property_id}}</span></td>
                                <td data-field="id_re" class="datatable-cell"><span>{{$property->card_real_estate_id}}</span></td>
                                <td data-field="open_date" class="datatable-cell"><span style="width: 50px;">{{$property->card_created_at}}</span></td>
...
{{--                                <td data-field="Ref_Ficha" class="datatable-cell"><span style="width: 50px;">{{$property->card_id}}</span></td>
                                <td data-field="reference" class="datatable-cell"><span>{{$property->ref ?? 'Sin referencia'}}</span></td>
...
{{--
                ...
                <!--end: Datatable-->
                <!-- <button onclick="$('.extra').table2CSV();">Export HTML Table To CSV File</button> -->
            </div>
        </div>
