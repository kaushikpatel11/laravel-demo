                    ...
                    <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatable" @if(DevideDetect::isIOS()) style="overflow: auto" @endif>
                        <table class="datatable  datatable-bordered datatable-head-custom" id="kt_datatable">
                            ...
                            <tr class="datatable-row">
                                ...
                                <th data-field="Id" class="datatable-cell datatable-cell-sort"><span>@lang('Id')</span></th>
                                <th data-field="Rating" class="datatable-cell datatable-cell-sort"><span>@lang('Rating')</span></th>
                                <th data-field="Status" class="datatable-cell datatable-cell-sort"><span>@lang('Estado')</span></th>
                                <th data-field="Name" class="datatable-cell datatable-cell-sort"><span>@lang('Nombre Comercial')</span></th>
                                <th data-field="Street" class="datatable-cell datatable-cell-sort"><span>@lang('Calle')</span></th>
                                <th data-field="City" class="datatable-cell datatable-cell-sort"><span>@lang('Ciudad')</span></th>
                                <th data-field="County" class="datatable-cell datatable-cell-sort"><span>@lang('Provincia')</span></th>
                                <th data-field="Phone" class="datatable-cell datatable-cell-sort"><span>@lang('Teléfono')</span></th>
                            ...
                            @foreach ($real_estates as $real_estate)
                                ...
                                <tr class="datatable-row" style="left: 0px;">
                                    ...
                                    <td data-field="Id" class="datatable-cell"><span style="width: 110px;">{{$real_estate->re_id}}</span></td>
                                    <td data-field="Rating" class="datatable-cell "><span style="width: 110px;">
                                            {{isset($real_estate->avg_rating) ? $real_estate->avg_rating : 0.0}}
                                    ...
                                    <td data-field="Status" aria-label="6" class="datatable-cell"><span
                                            style="width: 110px;"><span style="width: 110px;">
                                                @if($real_estate->status == '2')
                                                    @lang('Activa')
                                                @elseif($real_estate->status == '1')
                                                    @lang('En estado de pruebas')
                                                @else
                                                    @lang('Inactiva')
                                                @endif
                                                </span></span></td>
                                    ...
                                    <td data-field="Phone" aria-label="6" class="datatable-cell"><span
                                            style="width: 110px;"><span
                                                style="width: 110px;">{{$real_estate->phone_1}}</span></span></td>


                                    <td data-field="Actions" aria-label="Range Rover" class="datatable-cell"><span
                                            style="width: 115px;">

                                        <a href="{{ route('real_estate.detail',['id' => $real_estate->re_id]) }}"
